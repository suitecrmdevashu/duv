@extends('admin.layout.master', ['page_title' => 'Sports'])
@push('styles')
            ...
            <div class="card">
              <div class="card-header">
                <div class="card-title">
                    <h3 class="card-label">Sports</h3>
                </div>
                @if (\Auth::user()->isA('Admin'))
                <div class="card-toolbar">
                    <a href="/admin/sports/create" class="btn btn-primary font-weight-bolder">
        ...
        Swal.fire({
          ...
          if (result.value) {
            ...
            $.ajax({
              ...
              type: 'DELETE',
              url: '/admin/sports/delete/'+banner_id,

...
<!-- Content Header (Page header) -->
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Manage Banner Images</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
        <div class="container-fluid">
          ...
          <div class="col-12">
            ...
            <form class="form" method="POST" action="{{ route('banner.store') }}"  enctype="multipart/form-data" id="create_bannerimg_form">
                @csrf
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">New Banner Images</h3>
                  </div>
                  <!-- /.card-header -->
                  <!--begin::Form-->

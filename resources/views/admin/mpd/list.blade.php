...
<!-- Content Header (Page header) -->
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Manage MPD</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{URL::to('/admin/dashboard')}}">Home</a></li>
              <li class="breadcrumb-item active">MPD</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              <div class="card-header">
                <div class="card-title">
                    <h3 class="card-label">MPD</h3>
                </div>
                @if (\Auth::user()->isA('Admin'))
                <div class="card-toolbar">
                    <a href="/admin/mpd/create" class="btn btn-primary font-weight-bolder">
                ...
                <table id="mpd_datatable" class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">{{ $mpd->name}}</td>
                    ...
                    @elseif (Str::endsWith($mpd->file_path, '.pdf'))
                        <a href="{{ asset($mpd->file_path) }}" target="_blank">View PDF</a>
                    @endif
                      </td>
                        
                        <td class="text-center">
                          <a href="javascript:;" data-id="{{ $mpd->id }}" class="btn btn-sm btn-clean btn-icon delete_mpd" title="Delete">

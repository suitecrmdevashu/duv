    ...
    <section class="content">
        <div class="container-fluid">
          ...
          <div class="col-12">
            ...
            <form class="form" method="POST" action="{{ route('mpd.store') }}"  enctype="multipart/form-data" id="create_mpd_form">
                @csrf
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">New MPD</h3>
                  </div>
                  <!-- /.card-header -->
                  <!--begin::Form-->
...
<script>
    $(document).ready(function() {
        $('#create_mpd_form').submit(function(event) {
                ...
                success: function(response) {
                    ...
                    if (res.result == 'success') {
                        Swal.fire({
                            ...
                            window.location = '/admin/mpd';
                        });

                        $('#create_mpd_form')[0].reset();
                    }
                },

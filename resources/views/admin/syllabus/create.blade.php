@extends('admin.layout.master', ['page_title' => 'Syllabus'])
...
<!-- Content Header (Page header) -->
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Manage Syllabus</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
        <div class="container-fluid">
          ...
          <div class="col-12">
            ...
            <form class="form" method="POST" action="{{ route('syllabus.store') }}"  enctype="multipart/form-data" id="create_syllabus_form">
                @csrf
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">New Syllabus</h3>
                  </div>
                  <!-- /.card-header -->
                  <!--begin::Form-->
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-4">
                                <label>Title<span class="mandatory_input">*</span></label>
...
<script>
    $(document).ready(function() {
        $('#create_syllabus_form').submit(function(event) {
                ...
                success: function(response) {
                    ...
                    if (res.result == 'success') {
                        Swal.fire({
                            ...
                            window.location = '/admin/syllabus';
                        });

                        $('#create_syllabus_form')[0].reset();
                    }
                },

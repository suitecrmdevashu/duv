@extends('admin.layout.master', ['page_title' => 'Achievers-Create'])
...
<!-- Content Header (Page header) -->
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Manage Achievers</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
        <div class="container-fluid">
          ...
          <div class="col-12">
            ...
            <form class="form" method="POST" action="{{ route('achievers.store') }}"  enctype="multipart/form-data" id="create_lna_form">
                @csrf
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">New Achievers</h3>
                  </div>
                  <!-- /.card-header -->
                  <!--begin::Form-->
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (res.result == 'success') {
                        Swal.fire({
                            text: "Achievers Saved.",
                            type: 'success',
                            buttonsStyling: false,
                            confirmButtonText: "Ok",
                            confirmButtonClass: "btn font-weight-bold btn-primary"
                        }).then(function() {
                            window.location = '/admin/achievers';
                        });

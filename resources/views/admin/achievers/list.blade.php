@extends('admin.layout.master', ['page_title' => 'Achievers-List'])
@push('styles')
            ...
            <div class="card">
              <div class="card-header">
                <div class="card-title">
                    <h5 class="card-label">Achievers</h5>
                </div>
                @if (\Auth::user()->isA('Admin'))
                <div class="card-toolbar">
                    <a href="/admin/achievers/create" class="btn btn-primary font-weight-bolder">
        ...
        Swal.fire({
          ...
          if (result.value) {
            ...
            $.ajax({
              ...
              type: 'DELETE',
              url: '/admin/achievers/delete/'+lna_id,

@extends('admin.layout.master', ['page_title' => 'Edit Holidays'])
    ...
    <section class="content">
        <div class="container-fluid">
          ...
          <div class="col-12">
            ...
            <form class="form" id="edit_festival_form">
                @csrf
                <input type="hidden" name="festival_id" value="{{$festival['id']}}">
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">Edit Holidays Details</h3>
                  </div>
                  <!-- /.card-header -->
                  <!--begin::Form-->
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-4">
                                <label>Holidays Name <span class="mandatory_input">*</span></label>
                                <input type="text" class="form-control" id="name" name="name" placeholder="Festival Name" value="{{$festival['name']}}">
                                <div class="common-error form-text name_error"></div>
                            </div>

                            <div class="col-lg-4">
                              <label>Date <span class="mandatory_input">*</span></label>
                              <input type="date" class="form-control" id="date" name="date" placeholder="Festival Name" value="{{$festival['date']}}">

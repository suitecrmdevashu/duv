    ...
    <section class="content">
        <div class="container-fluid">
          ...
          <div class="col-12">
            ...
            <form class="form" method="POST" action="{{ route('feestructure.store') }}"  enctype="multipart/form-data" id="create_feestructure_form">
                @csrf
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">New Fee Structure</h3>
                  </div>
                  <!-- /.card-header -->
                  <!--begin::Form-->
...
<script>
    $(document).ready(function() {
        $('#create_feestructure_form').submit(function(event) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (res.result == 'success') {
                        Swal.fire({
                            text: "Fee Structure Saved.",
                            type: 'success',
                            buttonsStyling: false,
                            confirmButtonText: "Ok",
                            confirmButtonClass: "btn font-weight-bold btn-primary"
                        }).then(function() {
                            window.location = '/admin/fee-structure';
                        });

                        $('#create_feestructure_form')[0].reset();
                    }
                },
